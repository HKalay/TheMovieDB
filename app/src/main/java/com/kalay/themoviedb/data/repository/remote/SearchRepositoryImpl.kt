...
class SearchRepositoryImpl @Inject constructor(
    ...
    override suspend fun getSearchMovies(movieName: String, page: Int): List<DiscoverDTO> {
    ...
    override suspend fun getSearchTv(tvName: String, page: Int): List<DiscoverDTO> {
